...
`
    ...
    it("neutralizes spreadsheet formulas", () => {
        const assWithFormula = `[Script Info]
ScriptType: v4.00+
...
[Events]
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
Dialogue: 0,0:00:01.00,0:00:02.00,Default,,0000,0000,0000,,=2+3
`
        const t = parseAss(assWithFormula)
        const csv = convertToCsv(t, {
            ...DEFAULT_CSV_OPTIONS,
            showIndex: false,
            showStart: false,
    ...
    it("neutralizes formula injection with leading spaces or tabs", () => {
        const assWithSpaceFormula = `[Script Info]
ScriptType: v4.00+
...
[Events]
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
Dialogue: 0,0:00:01.00,0:00:02.00,Default,,0000,0000,0000,,   =CMD|' /C calc'!A1
`
        const t = parseAss(assWithSpaceFormula)
        const csv = convertToCsv(t, {
            ...DEFAULT_CSV_OPTIONS,
            showIndex: false,
            showStart: false,
