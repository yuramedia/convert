...
describe("convertNormalSrt — layer-aware sorting", () => {
    it("sorts same-timestamp lines by layer ascending", () => {
        ...
        const srt = convertNormalSrt(layerTrack, { useHtmlTags: false, mergeDuplicates: false, stripEmptyLines: true, uppercaseSigns: false })
    ...
    it("sorts reversed-layer input correctly", () => {
        ...
        const srt = convertNormalSrt(revTrack, { useHtmlTags: false, mergeDuplicates: false, stripEmptyLines: true, uppercaseSigns: false })
