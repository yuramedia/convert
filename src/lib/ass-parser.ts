...
function parseStylesLine(line: string, track: AssTrack): void {
    ...
    const style: AssStyle = {
        ...
        FontSize: parseFloat(raw["Fontsize"] || raw["FontSize"] || "18"),
        PrimaryColour: raw["PrimaryColour"] || "&H00FFFFFF",
        SecondaryColour: raw["SecondaryColour"] || "&H0000FFFF",
        OutlineColour: raw["OutlineColour"] || raw["TertiaryColour"] || "&H00000000",
        BackColour: raw["BackColour"] || "&H00000080",
        ...
        Outline: Math.max(parseFloat(raw["Outline"] || "0"), 0),
        Shadow: Math.max(parseFloat(raw["Shadow"] || "0"), 0),
        ...
        Encoding: parseInt(raw["Encoding"] || "0", 10),
